                    ...
                    foreach ($items as $item => $value) {
                        if ($item == 'name') {
                            echo "<tr><td><form method='post' class='form-inline' action='selectgame'><button type='submit' class='btn btn-primary' name='nopf' value='$items->nopf'><input value='$value' name='titel' style='display:none;'><input value='$items->nopt' name='nopt' style='display:none;'>Play game</button></form></td>" .
                                ...
                                echo "<td><form method='post' class='form-inline' action='removegame'><button type='submit' class='btn btn-primary' name='id' value='$items->id'><i class=\"fa fa-times-circle \"></i></button></form></td>";
                            }
                            echo "</tr>";
                        }
                    }
                        ...
                        if ($item == 'name') {
                            echo "<tr>" .
                                ...
                                echo "<td><form method='post' class='form-inline' action='/addsuggestion'>
                                        ...
                                        <button type='submit' class='btn btn-primary' name='id' value='$items->id'><i class=\"fa fa-times-circle \"></i></button></form></td>";
                            }
                            echo "</tr>";
                        }
                    }
