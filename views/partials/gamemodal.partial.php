            ...
            <div class="modal-body">
                <form method="post" action="addgame" class="form">
                    <div class="container">
                        ...
                        <div class="row form-group">
                            <input class="form-control" type="number" value="2001" id="example-number-input"
                                   name="date">
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value=0 name="score" required>Zonder
                                    score
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <textarea class="form-control" id="exampleTextarea" rows="3" placeholder="Omschrijving"
                                      name="omschrijving" required></textarea>
                        </div>
